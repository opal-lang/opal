...
func TestContractVerification_SaltReuse(t *testing.T) {
	...
	plan1.SecretUses = []planfmt.SecretUse{
		{DisplayID: "sigil:ABC", SiteID: "site1", Site: "root/shell[0]"},
	}
	plan1.Freeze()
	hash1 := plan1.Hash
...
func TestContractVerification_DetectsEnvironmentDrift(t *testing.T) {
	...
	plan1.Target = "deploy"
	plan1.SecretUses = []planfmt.SecretUse{
		{DisplayID: "sigil:DB_URL", SiteID: "site1", Site: "root/shell[0]/params/env"},
	}
	plan1.Freeze()
	hash1 := plan1.Hash
	salt1 := plan1.PlanSalt
	...
	plan2.SecretUses = []planfmt.SecretUse{
		{DisplayID: "sigil:DB_URL", SiteID: "site2", Site: "root/retry[0]/params/env"}, // Different site!
	}
	plan2.Freeze()
	hash2 := plan2.Hash
