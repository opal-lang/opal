	...
	tests := []struct {
		...
		},
		{
			...
			expected: []tokenExpectation{
				{types.IDENTIFIER, "test"},
				{types.COLON, ":"},
				{types.SHELL_TEXT, "echo $(find . -name "},
				{types.STRING_START, "\""},
				{types.STRING_TEXT, "*.go"},
				{types.STRING_END, "\""},
				{types.SHELL_TEXT, " -exec ls {} +)"},
				{types.SHELL_END, ""},
				{types.EOF, ""},
			},
		},
		...
		},
		{
			...
			expected: []tokenExpectation{
				{types.IDENTIFIER, "test"},
				{types.COLON, ":"},
				{types.SHELL_TEXT, "find . -name "},
				{types.STRING_START, "\""},
				{types.STRING_TEXT, "*.txt"},
				{types.STRING_END, "\""},
				{types.SHELL_TEXT, " -exec rm {} \\;"},
				{types.SHELL_END, ""},
				{types.EOF, ""},
			},
		},
		{
			...
			expected: []tokenExpectation{
				{types.IDENTIFIER, "test"},
				{types.COLON, ":"},
				{types.SHELL_TEXT, "for f in $(find . -name "},
				{types.STRING_START, "\""},
				{types.STRING_TEXT, "*.go"},
				{types.STRING_END, "\""},
				{types.SHELL_TEXT, "); do echo ${f%.go}.bin; done"},
				{types.SHELL_END, ""},
				{types.EOF, ""},
			},
		},
