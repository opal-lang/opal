  ...
  dev: @timeout(30s) { deploy dev }
    ...
    @parallel {
        ...
        kubectl logs deployment/worker
			...
			expected: []tokenExpectation{
				...
				{types.RPAREN, ")"},
				{types.LBRACE, "{"},
				{types.SHELL_TEXT, "echo \"Starting deployment\""},
				{types.AT, "@"},
				...
				{types.RBRACE, "}"},
				{types.SHELL_TEXT, "echo \"Deployment completed\""},
				{types.AT, "@"},
    ...
    default: echo "Unknown mode"
			...
			expected: []tokenExpectation{
				...
				{types.RPAREN, ")"},
				{types.LBRACE, "{"},
				{types.SHELL_TEXT, "echo \"Building for production...\""},
				{types.SHELL_TEXT, "NODE_ENV=production webpack --mode production"},
				{types.SHELL_TEXT, "echo \"Build completed\""},
				{types.SHELL_TEXT, "serve -s dist -l @var(PORT)"},
				{types.RBRACE, "}"},
    ...
    error: @retry(attempts = 3, delay = 2s) {
        ...
        echo "Retrying build..."
			...
			expected: []tokenExpectation{
				...
				{types.RPAREN, ")"},
				{types.LBRACE, "{"},
				{types.SHELL_TEXT, "echo \"Starting build process\""},
				{types.SHELL_TEXT, "npm run build:production"},
				{types.SHELL_TEXT, "npm run test:all"},
				{types.SHELL_TEXT, "echo \"Build successful\""},
				{types.RBRACE, "}"},
				...
				{types.RPAREN, ")"},
				{types.LBRACE, "{"},
				{types.SHELL_TEXT, "echo \"Build failed, cleaning up...\""},
				{types.SHELL_TEXT, "npm run clean"},
				{types.SHELL_TEXT, "echo \"Retrying build...\""},
				{types.RBRACE, "}"},
				// Finally branch simple syntax
				{types.IDENTIFIER, "finally"},
				{types.COLON, ":"},
				{types.SHELL_TEXT, "echo \"Build process completed\""},
				{types.RBRACE, "}"},
				{types.EOF, ""},
			},
		},
		...
		echo "Always execute"
			...
			expected: []tokenExpectation{
				...
				{types.RBRACE, "}"},
				{types.SHELL_TEXT, "echo \"Always execute\""}, // This was failing before
				{types.RBRACE, "}"},
				{types.EOF, ""},
			},
		},
	...
	@timeout(duration=TIMEOUT) {
		@parallel {
			...
			expected: []tokenExpectation{
				...
				{types.IDENTIFIER, "parallel"},
				{types.LBRACE, "{"},
				{types.SHELL_TEXT, "echo \"Task 1\""},
				{types.SHELL_TEXT, "echo \"Task 2\""},
				{types.SHELL_TEXT, "echo \"Task 3\""},
				{types.RBRACE, "}"},
				{types.RBRACE, "}"},
				{types.RBRACE, "}"},
				{types.EOF, ""},
